...
with open("AMiner_Author_50000.txt", mode="r", encoding="utf-8") as f:
    for line in f:
...
with open(train_path/"ad_matrix_training.csv") as f:
     reader = csv.reader(f)   
     next(reader)      # to ignore first row 
     for row in reader:
        for i in row:
...
with open(test_path/"ad_matrix_testing.csv") as f:
     reader = csv.reader(f)   
     next(reader)      # to ignore first row 
     for row in reader:
        for i in row:
