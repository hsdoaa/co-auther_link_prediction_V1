...
e3<-read.csv(file="coauthor_testing.csv", header=FALSE) # read  the 'co-authership per year 1990 from 1990.csv file
typeof(e3)
...
typeof(g)
V(g)
test_nodes<-V(g)$name# To get node names
write.matrix(test_nodes,file="test_nodes_ArnetMiner.txt") #To retrieve the names of all the vertices in the graph g
ad_matrix_testing<-get.adjacency(g,sparse=FALSE)
#write.matrix(ad_matrix_testing,file="ad_matrix_testing.txt")
write.matrix(ad_matrix_testing,file="ad_matrix_testing.csv",sep = ",")
...
#write.matrix(x_test,file="edge_list_test.txt")
...
write.table(jaccard, file = "jaccard_test.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
...
write.table(invlogweighted, file = "invlogweighted_test.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
...
write.table(dice, file = "dice_test.csv",row.names=FALSE, na="",col.names=FALSE, sep=",")
